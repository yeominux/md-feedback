...
### Fixed
- FILE_SAFETY false positive on Windows when drive letter casing differs between workspace root and incoming file path (`D:` vs `d:`). Path containment checks are now case-insensitive on Windows. (Issue #2)
